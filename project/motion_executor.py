...
class MotionExecutor:
    ...
    def plan_and_move_to_xyz(self, robot_name, target_xyz, rotation_matrix, speed=1.0, acceleration=1.0, blend_radius=0.05,
                                         tolerance=0.003, max_planning_time=5, max_length_to_distance_ratio=2,
                                         cannonized_config=True):
        target_transform = compose_transformation_matrix(rotation_matrix, target_xyz)
        goal_config = self.facing_down_ik(robot_name, target_transform, max_tries=50)
